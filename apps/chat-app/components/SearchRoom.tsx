  ...
  return (
    <div className="search-rooms flex ">
      ...
      <input
        ...
        className="px-3 py-2  border-gray-700 ml-8 border hover:border-purple-500  rounded-md"
      />
      ...
      <ul>
        {rooms.map((room) => (
          <li
            key={room.id}
            className="border p-4 m-4 border-gray-500 hover:border-purple-500 rounded border-solid py-2 cursor-pointer"
